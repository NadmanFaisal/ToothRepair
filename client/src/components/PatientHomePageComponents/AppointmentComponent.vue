      ...
      <div class="col-12 morning-container">
        ...
        <div class="col-10 slot-section">
          ...
          <div class="col-2 appointment-slot-container" v-for="appointment in appointments" :key="appointment.id" :class="{ 'available-slot': appointment.status === 'available', 'unavailable-slot': appointment.status !== 'available' }">
            ...
            <div class="col-8 appointment-information-container" @click="bookAppointment(appointment.id)">
  ...
  methods: {
    async createAppointment() {
      try {
        ...
        publishToTopic('ScheduleService/Appointment/createAppointment', '{"status": "availble", "date": "1111-11-11", "startTime": "09:30", "endTime": "10:00"}')
      } catch (error) {
    ...
    async bookAppointment(id) {
      try {
        await subscribeToTopic('Client/ScheduleService/AppointmentInfo')
        publishToTopic('ScheduleService/Appointment/bookAppointment', id)
